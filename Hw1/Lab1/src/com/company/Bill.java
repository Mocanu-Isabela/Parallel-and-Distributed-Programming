...
public record Bill(List<Product> products) {
    ...
    public static List<Bill> getRandomBills(List<ProductService> products, int numberOfBills) {
        ...
        for (int i = 0; i < numberOfBills; ++i) {
            ...
            for (int j = 0; j < productsInBill; ++j) {
                ...
                System.out.println("Product: " + name + ", " + quantity + ", " + price + " was added to the bill:" + i + " that has " + productsInBill + " products");
            }
